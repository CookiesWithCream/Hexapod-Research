...
# VERSION: WCONTROL32 - RESTORED WORKING W23 A/D STRAFE + FAST START
#
# Main updates:
...
def action_side_strafe_cycle(bus: DynamixelBus, direction: str, cycles: int = 1):
    ...
    for i in range(cycles):
        ...
        for mode_name, active, other, phase, delay in phases:
            ...
            ACTIVE_GOALS = dict(targets)
            move_targets_for_side_strafe(bus, targets, speed=GAIT_SPEED, hold_delay=delay, phase_label=CURRENT_MODE)
            if GAIT_PHASE_HEALTH:
                print_health(bus, CURRENT_MODE)
            else:
                print(f"{CURRENT_MODE}: sent")
...
def print_help():
    ...
    print(" WCONTROL35 W23 A/D STRAFE + PHASE-TUNED SUPPORT PUSH")
    print("===================================================")
...
def main():
    ...
    try:
        ...
        print("Phase-by-phase: sidestrafe debug enter on")
        print_help()
