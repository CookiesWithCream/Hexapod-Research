...
def action_gait_continuous(bus: DynamixelBus, direction: str):
    ...
    print()
    print("===================================================")
    print(f" SCONTROLX2 FULLSTEP SEMI-OVERLAP GAIT: {direction.upper()}")
    print("===================================================")
    hip_swing_deg, support_push_deg = movement_profile(direction)
    lift_femur, lift_tibia = gait_lift_values()
    ...
    print(f"Gait mode: SControlX2 fullstep semi-overlap, SControl3-like hold timing")
    print()
...
def action_gait_cycle(bus: DynamixelBus, direction: str, cycles: int = 1):
    ...
    print()
    print("===================================================")
    print(f" SCONTROLX2 FULLSTEP SEMI-OVERLAP GAIT {direction.upper()} x{cycles}")
    print("===================================================")
    hip_swing_deg, support_push_deg = movement_profile(direction)
    lift_femur, lift_tibia = gait_lift_values()
