...
# ============================================================
# V17 MODE SWITCHES + SAVED IK/BEZIER DEFAULTS
# ============================================================
# Purpose:
...
def print_motion_profile_status():
    print()
    print("===================================================")
    print(" MOTION PROFILE SWITCHES / V17")
    print("===================================================")
...
_WEB_PROFILE_SECTION = """<div class=\"section\"><h2>Movement Mode Switches</h2><div class=\"sub\">Switch between hardcoded fixed gait, efficient IK, and smoother Bézier IK. These do not move the robot by themselves.</div><div class=\"presetgrid\"><button id=\"btn_mode_fixed\" class=\"btn small\" onclick=\"presetCmd(this,'ik fixed')\">Fixed / Hardcoded</button><button id=\"btn_mode_ik\" class=\"btn small\" onclick=\"presetCmd(this,'ik efficient')\">IK Efficient</button><button id=\"btn_mode_bezier\" class=\"btn small\" onclick=\"presetCmd(this,'ik bezier_default')\">IK Bézier Smooth</button><button class=\"btn small\" onclick=\"presetCmd(this,'ik bezier on')\">Bezier ON</button><button class=\"btn small\" onclick=\"presetCmd(this,'ik bezier off')\">Bezier OFF</button><button id=\"btn_mode_bodyik\" class=\"btn small\" onclick=\"presetCmd(this,'ik bodyik')\">Body IK Test</button><button class=\"btn small\" onclick=\"presetCmd(this,'ik')\">IK Status</button><button class=\"btn small\" onclick=\"presetCmd(this,'bodyik')\">BodyIK Status</button><button class=\"btn small\" onclick=\"presetCmd(this,'health')\">Health Refresh</button></div></div>"""
