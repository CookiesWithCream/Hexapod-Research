...
_WEB_PROFILE_SECTION = """<div class=\"section\"><h2>Movement Control Mode</h2><div class=\"sub\">Switch between Fixed Gait, IK Motion, IK Bézier Motion, and Body IK posture testing. These buttons only change the motion mode; they do not move the robot by themselves.</div><div class=\"presetgrid\"><button id=\"btn_mode_fixed\" class=\"btn small\" onclick=\"presetCmd(this,'ik fixed')\">Fixed Gait</button><button id=\"btn_mode_ik\" class=\"btn small\" onclick=\"presetCmd(this,'ik motion')\">IK Motion</button><button id=\"btn_mode_bezier\" class=\"btn small\" onclick=\"presetCmd(this,'ik bezier_motion')\">IK Bézier Motion</button><button class=\"btn small\" onclick=\"presetCmd(this,'ik bezier_demo')\">Bézier Demo Motion</button><button class=\"btn small\" onclick=\"presetCmd(this,'ik bezier on')\">Bézier ON</button><button class=\"btn small\" onclick=\"presetCmd(this,'ik bezier off')\">Bézier OFF</button><button id=\"btn_mode_bodyik\" class=\"btn small\" onclick=\"presetCmd(this,'ik bodyik')\">Body IK Posture</button><button class=\"btn small\" onclick=\"presetCmd(this,'ik')\">IK Status</button><button class=\"btn small\" onclick=\"presetCmd(this,'bodyik')\">Body IK Status</button><button class=\"btn small\" onclick=\"presetCmd(this,'health')\">Health Refresh</button></div></div>"""
